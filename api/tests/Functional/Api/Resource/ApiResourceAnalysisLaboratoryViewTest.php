...
class ApiResourceAnalysisLaboratoryViewTest extends ApiTestCase
{
    use ApiTestRequestTrait;

    public function testGetCollectionReturnsLaboratories(): void
    {
        $client = self::createClient();

        $response = $this->apiRequest($client, 'GET', '/api/list/analyses/laboratories');
        ...
        $this->assertStringContainsString('/api/list/analyses/laboratories/', $first['@id']);
    }
    ...
    public function testGetItemByValue(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/list/analyses/laboratories');
