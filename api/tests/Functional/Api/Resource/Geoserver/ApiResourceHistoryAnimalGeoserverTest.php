...
class ApiResourceHistoryAnimalGeoserverTest extends ApiTestCase
{
    ...
    public function testGetCollectionJsonUnfiltered(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/history/animals', [
            'token' => $token,
            'headers' => [
    ...
    public function testGetCollectionJsonFiltered(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/history/animals?id[]=1', [
            'token' => $token,
            'headers' => [
                'Accept' => 'application/json',
            ],
    ...
    public function testGetCollectionGeoJson(): void
    {
        ...
        $this->assertStringStartsWith('history_animals:', $firstFeature['id']);
    }
    ...
    public function testGetNumberMatched(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/number_matched/history/animals', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
    ...
    public function testGetExtentMatched(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/extent_matched/history/animals', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
        $responseArray = $collectionResponse->toArray();
    ...
    public function testGetExport(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/export/history/animals', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
    }
