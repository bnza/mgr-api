...
class ApiResourceBotanySeedGeoserverTest extends ApiTestCase
{
    ...
    public function testGetCollectionJsonUnfiltered(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/botany/seeds', [
            'token' => $token,
            'headers' => [
    ...
    public function testGetCollectionJsonFiltered(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/botany/seeds?id[]=1', [
            'token' => $token,
            'headers' => [
                'Accept' => 'application/json',
            ],
    ...
    public function testGetCollectionGeoJson(): void
    {
        ...
        $this->assertStringStartsWith('botany_seeds:', $firstFeature['id']);
    }
    ...
    public function testGetNumberMatched(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/number_matched/botany/seeds', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
    ...
    public function testGetExtentMatched(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/extent_matched/botany/seeds', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
        $responseArray = $collectionResponse->toArray();
    ...
    public function testGetExport(): void
    {
        ...
        $collectionResponse = $this->apiRequest($client, 'GET', '/api/features/export/botany/seeds', [
            'token' => $token,
        ]);
        $this->assertResponseStatusCodeSame(200);
    }
