...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE analysis_sites_anthropology ADD CONSTRAINT FK_85856F2B23EDC87 FOREIGN KEY (subject_id) REFERENCES sites (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE sediment_cores ADD CONSTRAINT FK_7DF327F4F6BD1646 FOREIGN KEY (site_id) REFERENCES sites (id) ON DELETE RESTRICT NOT DEFERRABLE');
