...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE analyses_context_zoo (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_921C9D597941003F ON analyses_context_zoo (analysis_id)');
        $this->addSql('CREATE INDEX IDX_921C9D5923EDC87 ON analyses_context_zoo (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_921C9D5923EDC877941003F ON analyses_context_zoo (subject_id, analysis_id)');
        $this->addSql('CREATE TABLE analyses_zoo_bones (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_EE90A7517941003F ON analyses_zoo_bones (analysis_id)');
        $this->addSql('CREATE INDEX IDX_EE90A75123EDC87 ON analyses_zoo_bones (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EE90A75123EDC877941003F ON analyses_zoo_bones (subject_id, analysis_id)');
        $this->addSql('CREATE TABLE analyses_zoo_teeth (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_BB64200A7941003F ON analyses_zoo_teeth (analysis_id)');
        $this->addSql('CREATE INDEX IDX_BB64200A23EDC87 ON analyses_zoo_teeth (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BB64200A23EDC877941003F ON analyses_zoo_teeth (subject_id, analysis_id)');
        ...
        $this->addSql('CREATE TABLE pottery_analyses (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_D449D3F47941003F ON pottery_analyses (analysis_id)');
        $this->addSql('CREATE INDEX IDX_D449D3F423EDC87 ON pottery_analyses (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D449D3F423EDC877941003F ON pottery_analyses (subject_id, analysis_id)');
        ...
        $this->addSql('ALTER TABLE analyses_context_zoo ADD CONSTRAINT FK_921C9D597941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analyses_context_zoo ADD CONSTRAINT FK_921C9D5923EDC87 FOREIGN KEY (subject_id) REFERENCES contexts (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analyses_zoo_bones ADD CONSTRAINT FK_EE90A7517941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analyses_zoo_bones ADD CONSTRAINT FK_EE90A75123EDC87 FOREIGN KEY (subject_id) REFERENCES zoo_bones (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analyses_zoo_teeth ADD CONSTRAINT FK_BB64200A7941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analyses_zoo_teeth ADD CONSTRAINT FK_BB64200A23EDC87 FOREIGN KEY (subject_id) REFERENCES zoo_teeth (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_context_zoo_taxonomies ADD CONSTRAINT FK_87214BDC7941003F FOREIGN KEY (analysis_id) REFERENCES analyses_context_zoo (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE pottery_analyses ADD CONSTRAINT FK_D449D3F47941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE pottery_analyses ADD CONSTRAINT FK_D449D3F423EDC87 FOREIGN KEY (subject_id) REFERENCES potteries (id) ON DELETE CASCADE NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE analyses_context_zoo DROP CONSTRAINT FK_921C9D597941003F');
        $this->addSql('ALTER TABLE analyses_context_zoo DROP CONSTRAINT FK_921C9D5923EDC87');
        $this->addSql('ALTER TABLE analyses_zoo_bones DROP CONSTRAINT FK_EE90A7517941003F');
        $this->addSql('ALTER TABLE analyses_zoo_bones DROP CONSTRAINT FK_EE90A75123EDC87');
        $this->addSql('ALTER TABLE analyses_zoo_teeth DROP CONSTRAINT FK_BB64200A7941003F');
        $this->addSql('ALTER TABLE analyses_zoo_teeth DROP CONSTRAINT FK_BB64200A23EDC87');
        ...
        $this->addSql('ALTER TABLE pottery_analyses DROP CONSTRAINT FK_D449D3F47941003F');
        $this->addSql('ALTER TABLE pottery_analyses DROP CONSTRAINT FK_D449D3F423EDC87');
        ...
        $this->addSql('DROP TABLE analyses_context_zoo');
        $this->addSql('DROP TABLE analyses_zoo_bones');
        $this->addSql('DROP TABLE analyses_zoo_teeth');
