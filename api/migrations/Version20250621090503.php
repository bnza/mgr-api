...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE samples (id BIGINT NOT NULL, site_id BIGINT NOT NULL, year INT NOT NULL, number VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, su_id BIGINT DEFAULT NULL, context_id BIGINT DEFAULT NULL, PRIMARY KEY (id))');
