...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE context_zoo_analyses (id BIGINT NOT NULL, summary TEXT DEFAULT NULL, subject_id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE pottery_analyses (id BIGINT NOT NULL, summary TEXT DEFAULT NULL, item_id BIGINT NOT NULL, analysis_type_id SMALLINT NOT NULL, document_id BIGINT DEFAULT NULL, raw_data_id BIGINT DEFAULT NULL, PRIMARY KEY (id))');
