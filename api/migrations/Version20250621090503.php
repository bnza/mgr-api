...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE vocabulary.history_authors_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE vocabulary.history_cited_works_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE SEQUENCE vocabulary.regions_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE SEQUENCE sediment_core_depths_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE analysis_contexts_botany (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_762809397941003F ON analysis_contexts_botany (analysis_id)');
        $this->addSql('CREATE INDEX IDX_7628093923EDC87 ON analysis_contexts_botany (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7628093923EDC877941003F ON analysis_contexts_botany (subject_id, analysis_id)');
        $this->addSql('CREATE TABLE analysis_contexts_zoo (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_D1EF33FF7941003F ON analysis_contexts_zoo (analysis_id)');
        $this->addSql('CREATE INDEX IDX_D1EF33FF23EDC87 ON analysis_contexts_zoo (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D1EF33FF23EDC877941003F ON analysis_contexts_zoo (subject_id, analysis_id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6ABB30D923EDC877941003F ON analysis_samples_microstratigraphy (subject_id, analysis_id)');
        $this->addSql('CREATE TABLE analysis_sites_anthropology (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_85856F2B7941003F ON analysis_sites_anthropology (analysis_id)');
        $this->addSql('CREATE INDEX IDX_85856F2B23EDC87 ON analysis_sites_anthropology (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_85856F2B23EDC877941003F ON analysis_sites_anthropology (subject_id, analysis_id)');
        ...
        $this->addSql('CREATE TABLE archaeological_sites (id BIGINT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, chronology_lower SMALLINT DEFAULT NULL, chronology_upper SMALLINT DEFAULT NULL, field_director VARCHAR(255) DEFAULT NULL, the_geom Geography(Point,4326) DEFAULT NULL, created_by_id UUID DEFAULT NULL, region_id SMALLINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C57CC64677153098 ON archaeological_sites (code)');
        ...
        $this->addSql('CREATE TABLE contexts (id BIGINT NOT NULL, type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, site_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_AC51CEB5F6BD1646 ON contexts (site_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_AC51CEB5F6BD16465E237E06 ON contexts (site_id, name)');
        ...
        $this->addSql('CREATE TABLE history_animals (id BIGINT NOT NULL, chronology_lower SMALLINT NOT NULL, chronology_upper SMALLINT NOT NULL, reference VARCHAR(255) NOT NULL, notes VARCHAR(255) DEFAULT NULL, age_id SMALLINT NOT NULL, animal_id SMALLINT NOT NULL, location_id BIGINT NOT NULL, created_by_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_B20B4537CC80CD12 ON history_animals (age_id)');
        ...
        $this->addSql('CREATE TABLE vocabulary.history_authors (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, variant VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8EF768D11D775834 ON vocabulary.history_authors (value)');
        $this->addSql('CREATE TABLE vocabulary.history_cited_works (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_61EEA2001D775834 ON vocabulary.history_cited_works (value)');
        $this->addSql('CREATE TABLE vocabulary.history_languages (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_380EB751D775834 ON vocabulary.history_languages (value)');
        $this->addSql('CREATE TABLE vocabulary.history_locations (id BIGINT NOT NULL, value VARCHAR(255) NOT NULL, the_geom Geography(Point,4326) NOT NULL, region_id SMALLINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_B4B7F2B698260155 ON vocabulary.history_locations (region_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B4B7F2B61D775834 ON vocabulary.history_locations (value)');
        $this->addSql('CREATE TABLE history_plants (id BIGINT NOT NULL, chronology_lower SMALLINT NOT NULL, chronology_upper SMALLINT NOT NULL, reference VARCHAR(255) NOT NULL, notes VARCHAR(255) DEFAULT NULL, age_id SMALLINT NOT NULL, plant_id SMALLINT NOT NULL, location_id BIGINT NOT NULL, created_by_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_762190E5CC80CD12 ON history_plants (age_id)');
        ...
        $this->addSql('CREATE INDEX IDX_FABBF87677B05713 ON history_written_sources (written_source_type_id)');
        $this->addSql('CREATE INDEX IDX_FABBF876F675F31B ON history_written_sources (author_id)');
        $this->addSql('CREATE TABLE history_written_sources_cited_works (id BIGINT NOT NULL, year_completed SMALLINT NOT NULL, year_completed_upper SMALLINT DEFAULT NULL, written_source_id BIGINT NOT NULL, cited_work_id SMALLINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_DBE55CEAE1B4DE13 ON history_written_sources_cited_works (written_source_id)');
        ...
        $this->addSql('CREATE TABLE media_object_paleoclimate_sample (description TEXT DEFAULT NULL, id BIGINT NOT NULL, media_object_id BIGINT NOT NULL, item_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_366F6C8664DE5A5 ON media_object_paleoclimate_sample (media_object_id)');
        $this->addSql('CREATE INDEX IDX_366F6C86126F525E ON media_object_paleoclimate_sample (item_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_366F6C86126F525E64DE5A5 ON media_object_paleoclimate_sample (item_id, media_object_id)');
        $this->addSql('CREATE TABLE media_object_paleoclimate_sampling_sites (description TEXT DEFAULT NULL, id BIGINT NOT NULL, media_object_id BIGINT NOT NULL, item_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_811D51A664DE5A5 ON media_object_paleoclimate_sampling_sites (media_object_id)');
        $this->addSql('CREATE INDEX IDX_811D51A6126F525E ON media_object_paleoclimate_sampling_sites (item_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_811D51A6126F525E64DE5A5 ON media_object_paleoclimate_sampling_sites (item_id, media_object_id)');
        ...
        $this->addSql('CREATE TABLE paleoclimate_sample (id BIGINT NOT NULL, number INT NOT NULL, description TEXT DEFAULT NULL, chronology_lower SMALLINT DEFAULT NULL, chronology_upper SMALLINT DEFAULT NULL, length INT DEFAULT NULL, temperature_record BOOLEAN NOT NULL, precipitation_record BOOLEAN NOT NULL, stable_isotopes BOOLEAN NOT NULL, trace_elements BOOLEAN NOT NULL, petrographic_descriptions BOOLEAN NOT NULL, fluid_inclusions BOOLEAN NOT NULL, site_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_CD77A6DFF6BD1646 ON paleoclimate_sample (site_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CD77A6DFF6BD164696901F54 ON paleoclimate_sample (site_id, number)');
        $this->addSql('CREATE TABLE paleoclimate_sampling_sites (id BIGINT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, the_geom Geography(Point,4326) DEFAULT NULL, region_id SMALLINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7378983477153098 ON paleoclimate_sampling_sites (code)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_737898345E237E06 ON paleoclimate_sampling_sites (name)');
        $this->addSql('CREATE INDEX IDX_7378983498260155 ON paleoclimate_sampling_sites (region_id)');
        ...
        $this->addSql('CREATE TABLE auth.refresh_tokens (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, refresh_token VARCHAR(128) NOT NULL, username VARCHAR(255) NOT NULL, valid TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_39BB651DC74F2195 ON auth.refresh_tokens (refresh_token)');
        $this->addSql('CREATE TABLE vocabulary.regions (id SMALLINT NOT NULL, value VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F5053E851D775834 ON vocabulary.regions (value)');
        ...
        $this->addSql('CREATE TABLE sampling_sites (id BIGINT NOT NULL, code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, the_geom Geography(Point,4326) DEFAULT NULL, region_id SMALLINT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE INDEX IDX_EB9E272898260155 ON sampling_sites (region_id)');
        ...
        $this->addSql('ALTER TABLE analysis_context_botany_taxonomies ADD CONSTRAINT FK_94A277367941003F FOREIGN KEY (analysis_id) REFERENCES analysis_contexts_botany (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_context_botany_taxonomies ADD CONSTRAINT FK_94A277369557E6F6 FOREIGN KEY (taxonomy_id) REFERENCES vocabulary.botany_taxonomy (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_context_zoo_taxonomies ADD CONSTRAINT FK_87214BDC7941003F FOREIGN KEY (analysis_id) REFERENCES analysis_contexts_zoo (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE analysis_contexts_botany ADD CONSTRAINT FK_762809397941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_contexts_botany ADD CONSTRAINT FK_7628093923EDC87 FOREIGN KEY (subject_id) REFERENCES contexts (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_contexts_zoo ADD CONSTRAINT FK_D1EF33FF7941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_contexts_zoo ADD CONSTRAINT FK_D1EF33FF23EDC87 FOREIGN KEY (subject_id) REFERENCES contexts (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE analysis_sites_anthropology ADD CONSTRAINT FK_85856F2B7941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE analysis_sites_anthropology ADD CONSTRAINT FK_85856F2B23EDC87 FOREIGN KEY (subject_id) REFERENCES archaeological_sites (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE archaeological_sites ADD CONSTRAINT FK_C57CC646B03A8386 FOREIGN KEY (created_by_id) REFERENCES auth.users (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE history_animals ADD CONSTRAINT FK_B20B4537CC80CD12 FOREIGN KEY (age_id) REFERENCES vocabulary.history_languages (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE history_animals ADD CONSTRAINT FK_B20B453764D218E FOREIGN KEY (location_id) REFERENCES vocabulary.history_locations (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE vocabulary.history_locations ADD CONSTRAINT FK_B4B7F2B698260155 FOREIGN KEY (region_id) REFERENCES vocabulary.regions (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE history_plants ADD CONSTRAINT FK_762190E5CC80CD12 FOREIGN KEY (age_id) REFERENCES vocabulary.history_languages (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE history_plants ADD CONSTRAINT FK_762190E564D218E FOREIGN KEY (location_id) REFERENCES vocabulary.history_locations (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE media_object_paleoclimate_sample ADD CONSTRAINT FK_366F6C8664DE5A5 FOREIGN KEY (media_object_id) REFERENCES media_objects (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE media_object_paleoclimate_sample ADD CONSTRAINT FK_366F6C86126F525E FOREIGN KEY (item_id) REFERENCES paleoclimate_sample (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE media_object_paleoclimate_sampling_sites ADD CONSTRAINT FK_811D51A664DE5A5 FOREIGN KEY (media_object_id) REFERENCES media_objects (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE media_object_paleoclimate_sampling_sites ADD CONSTRAINT FK_811D51A6126F525E FOREIGN KEY (item_id) REFERENCES paleoclimate_sampling_sites (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE mus ADD CONSTRAINT FK_240A2C54A502ADE FOREIGN KEY (stratigraphic_unit_id) REFERENCES sus (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE paleoclimate_sample ADD CONSTRAINT FK_CD77A6DFF6BD1646 FOREIGN KEY (site_id) REFERENCES paleoclimate_sampling_sites (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE paleoclimate_sampling_sites ADD CONSTRAINT FK_7378983498260155 FOREIGN KEY (region_id) REFERENCES vocabulary.regions (id) ON DELETE RESTRICT NOT DEFERRABLE');
        $this->addSql('ALTER TABLE potteries ADD CONSTRAINT FK_91910162A502ADE FOREIGN KEY (stratigraphic_unit_id) REFERENCES sus (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE sampling_sites ADD CONSTRAINT FK_EB9E272898260155 FOREIGN KEY (region_id) REFERENCES vocabulary.regions (id) ON DELETE RESTRICT NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE auth.site_user_privileges ADD CONSTRAINT FK_7FEC3DADF6BD1646 FOREIGN KEY (site_id) REFERENCES archaeological_sites (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE sus ADD CONSTRAINT FK_32B2A22EF6BD1646 FOREIGN KEY (site_id) REFERENCES archaeological_sites (id) ON DELETE RESTRICT NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE vocabulary.history_authors_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE vocabulary.history_cited_works_id_seq CASCADE');
        ...
        $this->addSql('DROP SEQUENCE vocabulary.regions_id_seq CASCADE');
        ...
        $this->addSql('DROP SEQUENCE sediment_core_depths_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE analysis_context_botany_taxonomies DROP CONSTRAINT FK_94A277367941003F');
        $this->addSql('ALTER TABLE analysis_context_botany_taxonomies DROP CONSTRAINT FK_94A277369557E6F6');
        ...
        $this->addSql('ALTER TABLE analysis_contexts_botany DROP CONSTRAINT FK_762809397941003F');
        $this->addSql('ALTER TABLE analysis_contexts_botany DROP CONSTRAINT FK_7628093923EDC87');
        $this->addSql('ALTER TABLE analysis_contexts_zoo DROP CONSTRAINT FK_D1EF33FF7941003F');
        $this->addSql('ALTER TABLE analysis_contexts_zoo DROP CONSTRAINT FK_D1EF33FF23EDC87');
        ...
        $this->addSql('ALTER TABLE analysis_sites_anthropology DROP CONSTRAINT FK_85856F2B7941003F');
        $this->addSql('ALTER TABLE analysis_sites_anthropology DROP CONSTRAINT FK_85856F2B23EDC87');
        ...
        $this->addSql('ALTER TABLE archaeological_sites DROP CONSTRAINT FK_C57CC646B03A8386');
        ...
        $this->addSql('ALTER TABLE history_animals DROP CONSTRAINT FK_B20B4537CC80CD12');
        ...
        $this->addSql('ALTER TABLE vocabulary.history_locations DROP CONSTRAINT FK_B4B7F2B698260155');
        $this->addSql('ALTER TABLE history_plants DROP CONSTRAINT FK_762190E5CC80CD12');
        ...
        $this->addSql('ALTER TABLE media_object_paleoclimate_sample DROP CONSTRAINT FK_366F6C8664DE5A5');
        $this->addSql('ALTER TABLE media_object_paleoclimate_sample DROP CONSTRAINT FK_366F6C86126F525E');
        $this->addSql('ALTER TABLE media_object_paleoclimate_sampling_sites DROP CONSTRAINT FK_811D51A664DE5A5');
        $this->addSql('ALTER TABLE media_object_paleoclimate_sampling_sites DROP CONSTRAINT FK_811D51A6126F525E');
        ...
        $this->addSql('ALTER TABLE paleoclimate_sample DROP CONSTRAINT FK_CD77A6DFF6BD1646');
        $this->addSql('ALTER TABLE paleoclimate_sampling_sites DROP CONSTRAINT FK_7378983498260155');
        ...
        $this->addSql('ALTER TABLE sampling_sites DROP CONSTRAINT FK_EB9E272898260155');
        ...
        $this->addSql('DROP TABLE analysis_context_botany_taxonomies');
        $this->addSql('DROP TABLE analysis_context_zoo_taxonomies');
        $this->addSql('DROP TABLE analysis_contexts_botany');
        ...
        $this->addSql('DROP TABLE archaeological_sites');
        ...
        $this->addSql('DROP TABLE vocabulary.centuries');
        ...
        $this->addSql('DROP TABLE vocabulary.history_authors');
        $this->addSql('DROP TABLE vocabulary.history_cited_works');
        $this->addSql('DROP TABLE vocabulary.history_languages');
        ...
        $this->addSql('DROP TABLE media_object_paleoclimate_sample');
        ...
        $this->addSql('DROP TABLE paleoclimate_sample');
        $this->addSql('DROP TABLE paleoclimate_sampling_sites');
        ...
        $this->addSql('DROP TABLE vocabulary.regions');
