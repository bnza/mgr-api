...
final class Version20250621090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE context_botany_analyses (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_E3222D0B7941003F ON context_botany_analyses (analysis_id)');
        $this->addSql('CREATE INDEX IDX_E3222D0B23EDC87 ON context_botany_analyses (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E3222D0B23EDC877941003F ON context_botany_analyses (subject_id, analysis_id)');
        ...
        $this->addSql('CREATE TABLE context_zoo_analyses (summary TEXT DEFAULT NULL, id BIGINT NOT NULL, analysis_id BIGINT NOT NULL, subject_id BIGINT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_50370C097941003F ON context_zoo_analyses (analysis_id)');
        $this->addSql('CREATE INDEX IDX_50370C0923EDC87 ON context_zoo_analyses (subject_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_50370C0923EDC877941003F ON context_zoo_analyses (subject_id, analysis_id)');
        ...
        $this->addSql('ALTER TABLE analysis_context_botany_taxonomies ADD CONSTRAINT FK_94A277367941003F FOREIGN KEY (analysis_id) REFERENCES context_botany_analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE analysis_context_zoo_taxonomies ADD CONSTRAINT FK_87214BDC7941003F FOREIGN KEY (analysis_id) REFERENCES context_zoo_analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE context_botany_analyses ADD CONSTRAINT FK_E3222D0B7941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE context_botany_analyses ADD CONSTRAINT FK_E3222D0B23EDC87 FOREIGN KEY (subject_id) REFERENCES contexts (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE context_zoo_analyses ADD CONSTRAINT FK_50370C097941003F FOREIGN KEY (analysis_id) REFERENCES analyses (id) ON DELETE CASCADE NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE context_botany_analyses DROP CONSTRAINT FK_E3222D0B7941003F');
        $this->addSql('ALTER TABLE context_botany_analyses DROP CONSTRAINT FK_E3222D0B23EDC87');
        ...
        $this->addSql('ALTER TABLE context_zoo_analyses DROP CONSTRAINT FK_50370C097941003F');
        ...
        $this->addSql('DROP TABLE context_botany_analyses');
